    ...
    >
      <div className='container mx-auto'>
        <div className='flex justify-between items-center'>
          ...
          >
            {mobileNav ? <CgClose style={{zIndex:1, color:'#000000', position:'relative', backgroundColor:'#ffffff', borderRadius:'50%', padding:'4px'}}/> : <CgMenuRight />}
          </div>
          {/* nav */}
          ...
          <div
            ...
            } md:hidden fixed bottom-0 w-full max-w-xs h-screen transition-all z-0`}
          >
            <NavMobile />
          </div>
        </div>
