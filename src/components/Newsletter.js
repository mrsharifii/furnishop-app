...
const Newsletter = () => {
  const { title, subtitle, placeholder, buttonText, tel, address } = newsletter;
  return (
    <section className='section bg-newsletter min-h-[670px]' id="contact">
      <div className='container mx-auto flex justify-center lg:justify-end'>
        <div className='w-full max-w-[558px] text-center lg:text-left text-white'>
          <h4 className='text-2xl font-semibold max-w-[350px] mx-auto lg:mx-0 mb-5 leading-normal'>
            {tel}
          </h4>
          <h4 className='text-2xl font-semibold max-w-[350px] mx-auto lg:mx-0 mb-5 leading-normal'>
            {address}
          </h4>
          <h3 className='text-4xl font-semibold max-w-[350px] mx-auto lg:mx-0 mb-5 leading-normal'>
            {title}
          </h3>
