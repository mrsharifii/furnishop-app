...
export const hero = {
  title: 'Creative Home',
  subtitle:
    'make your house unique and attractive with luxury furniture. sweet dreams may come true but making a lovely place for living is your choice!',
  buttonText: 'Shop Now',
};
  ...
  persons: [
    {
      avatar: <Avatar1Img />,
      name: 'John Smith',
      occupation: 'Manager of LA Times',
      message:
    ...
    },
    {
      avatar: <Avatar2Img />,
      name: 'Sara Davis',
      occupation: 'Manager of SHATO',
      message:
        '“There are many Interest and useful furniture for a lot of people.”',
    },
    {
      avatar: <Avatar3Img />,
      name: 'Paul Minota',
      occupation: 'Manager of DYD',
      message:
        '“You have a lot of choices to design your home. Now, I love my home!”',
    },
  ],
};
...
export const newsletter = {
  ...
  buttonText: 'Shop Now',
  tel: '1-800-325-76130',
  address: '87 Nova St. San Francisco CA'
};
